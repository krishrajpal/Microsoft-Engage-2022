...
function MarkAttendence() {
	...
	const markAttendance = async (e) => {
		...
		try {
			...
			console.log(res);
			if (res == 0) {
				alert('Your attendence is not marked yet!');
			} else {
				alert('Your attendence is marked.Enjoy your Class!');
			}
		} catch (error) {
			console.log(error);
			alert('Error: Your attendence is not marked.');
		}
	};
				...
				<div className="relative bg-gradient-to-r from-gray-800 to-blue-900 md:pt-32 pb-32 pt-12 rounded-2xl">
					...
					<div className="flex flex-wrap">
						<div className="w-full px-10">
							<div className="relative flex flex-col min-w-0 break-words bg-white rounded-2xl shadow-lg">
								<div className="flex-auto p-4">
									<div className="flex flex-wrap">
										<div className=" w-full pr-4 max-w-full flex-grow flex-auto">
											<span className="flex justify-center text-blue-800  mr-0 whitespace-no-wrap text-4xl font-bold p-4 px-0">
												FaceLog Register Attendence
											</span>
										</div>
									</div>
									{validateCode._id ? null : (
										<div class="flex flex-col px-80 mt-6 mb-4">
											...
											<button
												class="mt-6 flex flex-col items-center px-2 py-4 rounded text-white cursor-pointer bg-blue-800 hover:bg-blue-500 focus:border-white"
										...
										<div class="flex flex-col px-80 mt-6 mb-4">
											...
											<label class="flex flex-col mt-6">
												...
												<span class="text-gray-600 font-light">
													Click to take picture and mark your attendence. Make sure webcam is
													allowed for browser.
												</span>
											</label>
											...
											>
												<span class="font-semibold ">Mark Attendence</span>
											</button>
										</div>
									) : null}
								</div>
